...
//
//SELECT td.id, td.trip_id, td.arrival_date, td.departure_date, td.country, td.state, td.city, td.timezone,
//td.lodging_type, td.lodging_address, td.trans_type
//	from trip_details td join trip t on td.trip_id = t.id 
//    where t.user_id = 5 and t.id = 4;